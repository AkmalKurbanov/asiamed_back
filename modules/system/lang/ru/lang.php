...
return [
    ...
    'settings' => [
        ...
        'test_subject' => 'Тест почтового драйвера',
        'test_content' => 'Это тестовое письмо для подтверждения того, что предоставленные настройки почты работают.',
        'test_confirm' => 'Это сохранит вашу текущую конфигурацию и отправит тестовое письмо на :email.',
